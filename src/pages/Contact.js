...
const Contact = () => {
    useDocTitle('Sw System | - Envie-nos uma mensagem')
            ...
            <div className="flex justify-center items-center mt-8 w-full bg-white py-12 lg:py-24 bg-gray-200">
                ...
                <form onSubmit={sendEmail}>
                    ...
                    <div className="w-full bg-white p-8 my-4 md:px-12 lg:w-9/12 lg:pl-20 lg:pr-40 mr-auto rounded-2xl shadow-2xl">
                        <div className="flex">
                            <h1 className="font-bold text-center lg:text-left text-blue-900 uppercase text-4xl">Envie-nos uma mensagem</h1>
                        </div>
                    ...
                    <div className="flex my-4 w-2/3 lg:w-1/2">
                        ...
                        <p className="text-gray-400">Tel: +55 (98) 984971547</p>
                            ...
                            <div className='mt-5'>
                                ...
                                <p className="text-gray-400">wesllesonsowza@gmail.com</p>
                            </div>
                    ...
                    <div className="flex my-4 w-2/3 lg:w-1/2">
                        ...
                        <a href="https://www.linkedin.com/in/wesleson-silva-244177281/" target="_blank" rel="noreferrer" className="rounded-full flex justify-center bg-white h-8 text-blue-900  w-8 inline-block mx-1 text-center pt-1">
                        ...
                        <a href="https://github.com/weslleson22" target="_blank" rel="noreferrer" className="rounded-full flex justify-center bg-white h-8 text-blue-900  w-8 inline-block mx-1 text-center pt-1">
